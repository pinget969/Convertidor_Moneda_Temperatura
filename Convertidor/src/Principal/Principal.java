		...
		while (true) {
 		String moneda2 = "Seleccione";
			...
			if (eleccion == "Convertidor de moneda") {
				...
				String temperatura1 = (String) JOptionPane.showInputDialog(null, "Seleccione un tipo de conversión",
				...
				if (temperatura1 != "Seleccione" && temperatura1 != null) {
					temperatura2 = (String) JOptionPane.showInputDialog(null, "Seleccione un tipo de moneda",
							"OPCIONES", JOptionPane.QUESTION_MESSAGE, null,
							new Object[] { "Seleccione", "Grados Celsius", "Grado Fahrenheit", "Kelvin" },
							"Seleccione");

				} else if (temperatura1 == null) {
					JOptionPane.showMessageDialog(null, "Cancelado");
